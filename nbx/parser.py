# AUTOGENERATED! DO NOT EDIT! File to edit: ../notebooks/06_my_parser.ipynb.

# %% auto 0
__all__ = ['fail', 'item', 'seed', 'tag_rx', 'p', 'flagname_rx', 'parse_tagged_line', 'is_nbx', 'TEMPLATES', 'include_rx',
           'Parser', 'result', 'result_or_none', 'seq', 'compr', 'many', 'many1', 'parse_any_tag', 'rx_parser',
           'parse_flagname', 'starts_with_flag', 'parse_flags', 'is_nbx_cell', 'get_nbx_cells', 'Line', 'TaggedLine',
           'EmptyLine', 'tokenize_lines', 'parse_nbx', 'create_script', 'parse_jl_include']

# %% ../notebooks/06_my_parser.ipynb 3
...
# %% ../notebooks/06_my_parser.ipynb 7
def many(q):
...
# %% ../notebooks/06_my_parser.ipynb 11
import re
...
# %% ../notebooks/06_my_parser.ipynb 14
def rx_parser(rx):
    def p(line):
        m = rx.match(line)
        if m is not None: 
...
# %% ../notebooks/06_my_parser.ipynb 16
import re
...
# %% ../notebooks/06_my_parser.ipynb 19
from collections import defaultdict
import shlex 
...
# %% ../notebooks/06_my_parser.ipynb 21
parse_tagged_line = seq(parse_any_tag, parse_flags)

# %% ../notebooks/06_my_parser.ipynb 24
...
# %% ../notebooks/06_my_parser.ipynb 26
...
# %% ../notebooks/06_my_parser.ipynb 28
class Line(object):
...
# %% ../notebooks/06_my_parser.ipynb 30
...
# %% ../notebooks/06_my_parser.ipynb 34
...
# %% ../notebooks/06_my_parser.ipynb 37
...
# %% ../notebooks/06_my_parser.ipynb 39
...
# %% ../notebooks/06_my_parser.ipynb 41
import re
